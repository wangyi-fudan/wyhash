...
wyrand is as simple as:

  inline unsigned long long wyrand(unsigned long long	*s) {
      *s+=11464284564125869423ull;   
      __uint128_t    t=(__uint128_t)(*s^14117165359962661627ull)*(*s);   
      return	(t>>64)^t;
  }
