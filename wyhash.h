...
static	inline	unsigned long long	wytruerand(unsigned long long *s,	unsigned long long secret){	*s=_wymum(_wymum(*s^_wyp0,	clock()^_wyp1),	_wymum(secret^_wyp2,	time(NULL)^_wyp3));	return	_wymum(*s^_wyp4,*s);	}
